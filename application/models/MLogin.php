...
class MLogin extends CI_model {
	...
	public function login($data) {
		...
		$check_username = $this->db->get_where('admin',array('USERNAME' => $username_input))->first_row();
		if($check_username){
	...
	public function login_backoffice_panitia($data) {

		$condition = "NIP =" . "'" . $data['user_username'] . "' AND " . "PASSWORD =" . "'" . $data['user_password'] . "'";
		$this->db->select('*');
	...
	public function read_user_information_panitia($username) {
